...
namespace Droids.Component
{
    public class CharacterControllerComponent : MonoBehaviour
    {
        ...
        public void Move(Vector2 vector, bool force = false)
        {
            if (!CanMove && !force)
                return;
        ...
        private void CheckRight()
        {
            ...
            Collider2D top = Physics2D.OverlapArea(TopRightBox.TopLeft, TopRightBox.BottomRight, m_groundDetection);
            Collider2D middle = Physics2D.OverlapArea(MiddleRightBox.TopLeft, MiddleRightBox.BottomRight, m_groundDetection);
            Collider2D bottom = Physics2D.OverlapArea(BottomRightBox.TopLeft, BottomRightBox.BottomRight, m_groundDetection);
